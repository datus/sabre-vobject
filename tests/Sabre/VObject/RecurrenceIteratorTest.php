...
class RecurrenceIteratorTest extends \PHPUnit_Framework_TestCase {
    ...
    function testValues() {
        ...
        $dtStart->setDateTime($this->getDt('2011-10-07'));
    ...
    function testHourly() {
        ...
        $dtStart = new Property\DateTime('DTSTART');
        $dtStart->setDateTime($this->getDt('2011-10-07 12:00:00'));
    ...
    function testDailyByDayByHour() {
        ...
        $dtStart = new Property\DateTime('DTSTART');
        $dtStart->setDateTime($this->getDt('2011-10-08 06:00:00'));
    ...
    function testDailyByHour() {
        ...
        $dtStart = new Property\DateTime('DTSTART');
        $dtStart->setDateTime($this->getDt('2012-10-11 12:00:00'));
    ...
    function testWeeklyByDayByHour() {
        ...
        $dtStart = new Property\DateTime('DTSTART');
        $dtStart->setDateTime($this->getDt('2011-10-07 08:00:00'));
    ...
    function testWeeklyByDaySpecificHour() {
        ...
        $dtStart = new Property\DateTime('DTSTART');
        $dtStart->setDateTime($this->getDt('2011-10-07 18:00:00'));
    ...
    function testMonthly() {
        ...
        $dtStart = new Property\DateTime('DTSTART');
        $dtStart->setDateTime($this->getDt('2011-12-05'));
    ...
    function testMonthlyEndOfMonth() {
        ...
        $dtStart = new Property\DateTime('DTSTART');
        $dtStart->setDateTime($this->getDt('2011-12-31'));
    ...
    function testMonthlyByMonthDay() {
        ...
        $dtStart = new Property\DateTime('DTSTART');
        $dtStart->setDateTime($this->getDt('2011-01-01'));
    ...
    function testMonthlyByDay() {
        ...
        $dtStart = new Property\DateTime('DTSTART');
        $dtStart->setDateTime($this->getDt('2011-01-03'));
    ...
    function testMonthlyByDayByMonthDay() {
        ...
        $dtStart = new Property\DateTime('DTSTART');
        $dtStart->setDateTime($this->getDt('2011-08-01'));
    ...
    function testYearlyLeapYear() {
        ...
        $dtStart = new Property\DateTime('DTSTART');
        $dtStart->setDateTime($this->getDt('2012-02-29'));
    ...
    function testYearlyByMonth() {
        ...
        $dtStart = new Property\DateTime('DTSTART');
        $dtStart->setDateTime($this->getDt('2011-04-07'));
    ...
    function testYearlyByMonthByDay() {
        ...
        $dtStart = new Property\DateTime('DTSTART');
        $dtStart->setDateTime($this->getDt('2011-04-04'));
    ...
    function testComplexExclusions() {
        ...
        $exDate1 = new Property\DateTime('EXDATE');
        $exDate1->setDateTime(array(new DateTime('2012-01-01 13:50:20', $tz), new DateTime('2014-01-01 13:50:20', $tz)));
        $exDate2 = new Property\DateTime('EXDATE');
        $exDate2->setDateTime(array(new DateTime('2016-01-01 13:50:20', $tz)));
